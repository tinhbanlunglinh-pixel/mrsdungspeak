            ...
            <div className="p-4 sm:p-8 overflow-auto max-h-[80vh]">
              ...
              >
                ...
                <div className="px-6 sm:px-12 py-4 sm:py-6 rounded-[2rem]" style={{ background: 'linear-gradient(to bottom right, #f0fdf4, #d1fae5)', border: '4px solid #ffffff', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)' }}>
                  ...
                  <p className="text-4xl sm:text-6xl font-black" style={{ color: '#065f46', textShadow: '3px 3px 0 white' }}>{evaluation.score}<span className="text-xl sm:text-2xl" style={{ color: '#34d399' }}>/10</span></p>
                </div>
